...
const SkillsWheel = ({ skillsData }) => {
  ...
  const wheelConfig = useMemo(() => {
    ...
    const radius = Math.floor((wheelSize - orbitItemSize) / 2) - 4;
    const centerSize = Math.max(110, Math.round(orbitItemSize * 1.35));
    const centerOffset = centerSize / 2;
    const gearSize = Math.max(72, Math.round(wheelSize * 0.28));
  ...
  return (
    <div className="w-full min-h-[520px] sm:min-h-[600px] md:min-h-[640px] md:mb-10 flex items-center justify-center flex-col lg:flex-row">
      <div className="flex items-center justify-center">
        ...
        <div
          ...
          style={{
            width: `${wheelConfig.wheelSize}px`,
            height: `${wheelConfig.wheelSize}px`,
          }}
        ...
        >
          ...
          style={{
            width: `${wheelConfig.gearSize}px`,
            height: `${wheelConfig.gearSize}px`,
            marginTop: `-${wheelConfig.gearSize / 2}px`,
            marginLeft: `-${wheelConfig.gearSize / 2}px`,
          ...
          >
            {(() => {
              ...
              return displayed.map((skill, index) => {
                ...
                const halfItem = wheelConfig.orbitItemSize / 2;
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      left: `calc(50% + ${x}px - ${halfItem}px)`,
                      top: `calc(50% + ${y}px - ${halfItem}px)`,
                      width: `${wheelConfig.orbitItemSize}px`,
                      height: `${wheelConfig.orbitItemSize}px`,
          ...
          {selectedSkill && (
            <motion.div
              ...
              style={{
                zIndex: 10,
                width: `${wheelConfig.centerSize}px`,
                height: `${wheelConfig.centerSize}px`,
                marginTop: `-${wheelConfig.centerOffset}px`,
                marginLeft: `-${wheelConfig.centerOffset}px`,
              }}
            ...
            >
              ...
              />
              <h2 className="text-white text-lg sm:text-xl md:text-2xl font-semibold border-t-2 mt-3 px-3">{selectedSkill}</h2>
            </motion.div>
          )}
        </div>
      </div>
      ...
      <AnimatePresence>
        {selectedSkill && (
          <motion.div
            className={`mt-8 lg:mt-0 lg:ml-20 w-full max-w-[540px] bg-gray-800 p-4 rounded-lg`}
